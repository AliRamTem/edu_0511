...
class Cat {
    ...
    public boolean fight(Cat anotherCat) {
        ...
        int scoreAge = Integer.compare(this.age, anotherCat.age);
        int scoreWeight = Integer.compare(this.weight, anotherCat.weight);
        int scoreStrength = Integer.compare(this.strength, anotherCat.strength);
        return (scoreAge + scoreWeight + scoreStrength) > 0;
    }
}
