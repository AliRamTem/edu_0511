...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("У меня две бабушки, бабушка " + gosha.getFather().getMother().getName() +
                " и " + gosha.getMother().getMother().getName());
        System.out.println("У меня два деда, деда " + gosha.getFather().getFather().getName() +
