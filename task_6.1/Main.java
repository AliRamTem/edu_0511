...
public class Main {
    public static void main(String[] args) {
        ...
        Person nikita = new Person("Никита", 64, null,null);
        Person anna = new Person("Анна", 62, null,null);
        Person kolya = new Person("Коля", 63, null,null);
        Person oleg = new Person("Олег",40,anna,kolya);
        Person olga = new Person("Ольга",35,nina,nikita);
